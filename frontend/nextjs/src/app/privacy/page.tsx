...
const description = 'プライバシーポリシーに関するページです。';

export const metadata = {
  title: {
    default: `プライバシーポリシー｜${siteName}`,
    template: `%s - ${siteName}`,
  },
  description,
};
    ...
    <InfoLayout>
      <div className="bg-white shadow rounded-lg md:mt-0 w-full xl:p-0 mx-auto">
        <div className="p-6 sm:p-8 lg:p-8 space-y-8">
          <h1 className="text-2xl lg:text-3xl font-normal text-gray-900">プライバシーポリシー</h1>
          <p>
            {siteName}
            のページ管理者（以下、「管理者」といいます。）は、本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における、ユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下、「本ポリシー」といいます。）を定めます。
          </p>
          ...
          <ol>
            ...
            <li>ユーザーが利用中のサービスの新機能、更新情報、キャンペーン等及び管理者が提供する他のサービスの案内のメールを送付するため</li>
          ...
          <ol>
            ...
            <li>利用目的の変更を行った場合には、変更後の目的について、管理者所定の方法により、ユーザーに通知し、または本ウェブサイト上に公表するものとします。</li>
          </ol>
          ...
          <ol>
            <li>
              ...
              <ol>
                ...
                <li>管理者の業務の適正な実施に著しい支障を及ぼすおそれがある場合</li>
          ...
          <ol>
            ...
            <li>管理者が別途定める場合を除いて、変更後のプライバシーポリシーは、本ウェブサイトに掲載したときから効力を生じるものとします。</li>
          </ol>
